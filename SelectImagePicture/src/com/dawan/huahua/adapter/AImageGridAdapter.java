...
import com.dawan.huahua.base.BitmapCache;
import com.dawan.huahua.base.BitmapCache.ImageCallback;
...
public class AImageGridAdapter extends BaseAdapter {
	...
	public AImageGridAdapter(Activity act, List<ImageItem> list, Handler mHandler) {
		this.act = act;
		dataList = list;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.iv.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if ((ABimp.drr.size() + selectTotal) < 5) {
				...
				} else if ((ABimp.drr.size() + selectTotal) >= 5) {
